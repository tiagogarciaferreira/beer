...
Beer.GraficoVendaPorMes = (function() {
	
	function GraficoVendaPorMes() {
		this.ctx = $('#graficoVendasPorMes')[0].getContext('2d');
		this.vendaGraficoMesesUrl = $('#vendaGraficoMeses');
	}
	
	GraficoVendaPorMes.prototype.iniciar = function() {
		$.ajax({
			url: this.vendaGraficoMesesUrl.data('url'),
			method: 'GET', 
...
$(function() {
	var graficoVendaPorMes = new Beer.GraficoVendaPorMes();
	graficoVendaPorMes.iniciar();
	
	var graficoVendaPorOrigem = new Beer.GraficoVendaPorOrigem();
